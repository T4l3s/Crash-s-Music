...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    let Config = new MessageEmbed()
      ...
      .addField("DJ Role", GuildDB.DJ ? `<@&${GuildDB.DJ}>` : "Desativado", true)
      .setDescription(`
...
`);
    ...
    if (em._emoji.name === "1️⃣") {
      await client.sendTime(message.channel, "Para o que você deseja alterar o prefixo?");
  ...
  SlashCommand: {
    options: [
      {
        name: "prefix",
        description: "Olhe o prefixo que você está usando",
        type: 1,
        required: false,
        options: [
          {
            name: "symbol",
            description: "Set o símbolo do seu prefixo",
            type: 3,
            required: false,
          },
        ],
      ...
      {
        name: "dj",
        description: "Olhe o cargo do DJ",
        type: 1,
        required: false,
        options: [
          {
            name: "role",
            description: "Set o cargo do DJ",
            type: 8,
            required: false,
          },
        ],
