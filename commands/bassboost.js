...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        return client.sendTime(message.channel, `✅ | **Nível de Bassboost definido para** \`${level}\``);
    },
    SlashCommand: {
        options: [
            {
                name: "level",
                description: `Forneça um nível de bassboost. Níveis Disponíveis: low, medium, high, or none`,
                value: "[level]",
                type: 3,
                required: true,
            },
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (!args) return client.sendTime(interaction, "**Forneça um nível de bassboost. \nNíveis Disponíveis:** `none`, `low`, `medium`, `high`"); //if the user do not provide args [arguments]
            ...
            return client.sendTime(interaction, `✅ | **Defina o nível de bassboost para** \`${level}\``);
        },
    },
};
